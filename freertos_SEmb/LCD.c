...
GPIOPinWrite(GPIO_PORTE_BASE, D4, 0);
if(a & 2)
GPIOPinWrite(GPIO_PORTE_BASE, D5, D5);
else
GPIOPinWrite(GPIO_PORTE_BASE, D5, 0);
if(a & 4)
GPIOPinWrite(GPIO_PORTE_BASE, D6, D6);
else
GPIOPinWrite(GPIO_PORTE_BASE, D6, 0);
if(a & 8)
GPIOPinWrite(GPIO_PORTE_BASE, D7, D7);
else
GPIOPinWrite(GPIO_PORTE_BASE, D7, 0);
}
/**************************************************************
...
SysCtlDelay(10000);// adding delay
}
/**************************************************************
